/**
 * Canonical Endpoint Path Resolver (ESM)
 * 
 ...
 */
export function pathsAreEquivalent(path1, path2) {
 ...
 */
export function isIntentionallyMissing(path) {
  const normalized = normalizePath(path);
 ...
 */
export function getAliasInfo(path) {
  const normalized = normalizePath(path);
