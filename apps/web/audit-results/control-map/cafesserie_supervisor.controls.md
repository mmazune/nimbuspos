# Control Map: cafesserie/supervisor

**Extracted:** 2026-01-20T01:39:17.771Z
**Duration:** 71.9s
**Routes Visited:** 11
**Controls Found:** 198
**Missing TestId:** 165 (83.3%)
...
| button | User menu for Paula Supervisor | user-menu-trigger | ❓ unknown | `getByTestId('user-menu-trigger')` |
...
|------|------|--------|------|---------|
| button | Refresh | - | ❓ unknown | `getByText('Refresh')` |
| button | Pending (0) | - | ❓ unknown | `getByText('Pending (0)')` |
| button | History | - | ❓ unknown | `getByText('History')` |
| button | Open Tanstack query devtools | - | ❓ unknown | `getByText('Open Tanstack query devtools')` |
| link | Skip to main content | - | ✅ read-only | `getByText('Skip to main content')` |
...
Shift overview | - | ✅ read-only | `getByText('Dashboard

Shift overview')` |
| link | POS

Access point of sale | - | ✅ read-only | `getByText('POS

Access point of sale')` |
| link | Staff

View team schedule | - | ✅ read-only | `getByText('Staff

View team schedule')` |
| link | Reservations

Manage bookings | - | ✅ read-only | `getByText('Reservations

Manage bookings')` |
| link | Voids & Discounts

Approve tra | - | ⚠️ mutation | `getByText('Voids & Discounts

Approve transactions` |
| link | End of Day

Close out the day | - | ⚠️ mutation | `getByText('End of Day
