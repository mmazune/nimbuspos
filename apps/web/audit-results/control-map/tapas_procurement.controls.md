# Control Map: tapas/procurement

**Extracted:** 2026-01-20T01:29:44.397Z
**Duration:** 87.3s
**Routes Visited:** 15
**Controls Found:** 301
**Missing TestId:** 253 (84.1%)
...
| button | User menu for Dan Procurement | user-menu-trigger | ❓ unknown | `getByTestId('user-menu-trigger')` |
