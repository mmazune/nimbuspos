# Control Map: tapas/accountant

**Extracted:** 2026-01-20T01:28:16.354Z
**Duration:** 88.2s
**Routes Visited:** 15
**Controls Found:** 238
...
| button | User menu for Carol Accountant | user-menu-trigger | ❓ unknown | `getByTestId('user-menu-trigger')` |
