# Coverage Report: cafesserie/manager

**Generated:** 2026-01-20T00:30:20.644Z
**Duration:** 87.4s
...
| Metric | Count | % |
|--------|-------|---|
| Total Controls | 341 | 100% |
| ✅ Covered | 208 | 61% |
| ⚠️ Skipped (Mutation) | 16 | 5% |
| 🚫 Skipped (Unreachable) | 117 | 34% |
...
| /analytics | button | User menu for Mike Manage | domChange: Button clicked (no observable side effe |
