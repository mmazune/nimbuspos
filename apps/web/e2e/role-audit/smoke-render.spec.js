...
test_1.test.describe('M59 Smoke Render', () => {
    test_1.test.setTimeout(120000);
    (0, test_1.test)('tapas/owner can render key routes without 500', async ({ page }) => {
        const roleConfig = {
            org: 'tapas',
            role: 'owner',
        ...
        (0, test_1.expect)(failedRoutes.length).toBe(0);
    });
});
//# sourceMappingURL=smoke-render.spec.js.map