...
// Helpers
// =============================================================================
function isMutationControl(label, controlType) {
...
test_1.test.describe('Coverage Audit', () => {
    test_1.test.setTimeout(200000); // 3+ min per role
    for (const roleConfig of roles) {
        (0, test_1.test)(`Coverage ${roleConfig.org}/${roleConfig.role}`, async ({ page }) => {
...
function generateCoverageMarkdown(result) {
    const lines = [
...
//# sourceMappingURL=coverage-audit.spec.js.map