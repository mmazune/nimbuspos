...
exports.verifyLandingPage = verifyLandingPage;
exports.formatVisibilityResult = formatVisibilityResult;
exports.getVisibilityMarkdown = getVisibilityMarkdown;
/**
 ...
 */
async function verifyLandingPage(page, config) {
 ...
 */
function formatVisibilityResult(result) {
 ...
 */
function getVisibilityMarkdown(result) {
    const status = result.failed === 0 ? '✅' : '⚠️';
    let md = `
---
