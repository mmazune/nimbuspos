...
// Main Test Suite
// =============================================================================
test_1.test.describe('Render Contract', () => {
    test_1.test.setTimeout(300000); // 5 min per role
    for (const roleConfig of TEST_ROLES) {
        (0, test_1.test)(`Render Contract ${roleConfig.org}/${roleConfig.role}`, async ({ page }) => {
            ...
            for (const route of routes) {
                ...
                try {
                    ...
                    hasErrorBoundary = ERROR_BOUNDARY_INDICATORS.some(indicator => bodyText.includes(indicator));
                    // Capture errors
                    ...
                    const hasFailed = navigationStatus === 500 ||
...
//# sourceMappingURL=render-contract.spec.js.map