...
test_1.test.describe('M63 Sidebar Actionability Proof', () => {
    test_1.test.setTimeout(180000); // 3 min per role
    for (const roleConfig of ROLES_TO_TEST) {
        (0, test_1.test)(`${roleConfig.org}/${roleConfig.role} sidebar actionability + navigation clicks`, async ({ page }) => {
            const result = {
                org: roleConfig.org,
            ...
            try {
                ...
                (0, test_1.expect)(result.totalNavElements).toBeGreaterThanOrEqual(10);
                ...
                // Assert pass
                (0, test_1.expect)(result.passed, result.error).toBe(true);
            }
            catch (err) {
...
//# sourceMappingURL=sidebar-actionability.spec.js.map