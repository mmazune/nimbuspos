...
function saveReport(report) {
    ...
    fs.writeFileSync(path.join(OUTPUT_DIR, `${basename}_v1.1.json`), JSON.stringify(report, null, 2));
 ...
 */
async function testReceiptPage(page, receiptId, watchers) {
...
//# sourceMappingURL=print-export-job-contract-v1.1.spec.js.map