...
describe('M12.6 Close Requests Page', () => {
    ...
    it('renders close requests page', async () => {
        const { default: CloseRequestsPage } = await Promise.resolve().then(() => __importStar(require('../src/pages/inventory/close-requests')));
        (0, react_2.render)(<CloseRequestsPage />, { wrapper: createWrapper() });
...
//# sourceMappingURL=m126-inventory-close-ops-pages.test.js.map