...
>(({ className = '', ...props }, ref) => (
  <tr
    ref={ref}
    className={`border-b border-nimbus-mist dark:border-white/10 transition-colors hover:bg-nimbus-mist/50 dark:hover:bg-white/5 data-[state=selected]:bg-nimbus-mist ${className}`}
    {...props}
  />
));
